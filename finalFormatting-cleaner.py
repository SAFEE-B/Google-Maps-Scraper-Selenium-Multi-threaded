...
output_file = 'xxxx.xlsx'  # Output file name

# Cities to filter by (comma-separated string)
city_names_string = "roseville,danbury"
state_filters = ["MO","KS"]
US_Filter = ["United States"]

# Convert city names string to a list
city_names = [city.strip() for city in city_names_string.split(",")]
...
print_status("After removing empty rows", df.shape[0])
